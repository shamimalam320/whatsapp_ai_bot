        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-8 max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto">
            ...
            <div className="text-sm text-gray-700 mb-4 space-y-2">
              <p>
                <strong>Required CSV Headers:</strong> name, description, price, category, stock, size, color, weight, weightUnit (gram/kg), images (semicolon separated).
              </p>
              <p className="text-green-700 font-semibold">
                <strong>Optional:</strong> variants - semicolon-separated list with format <code className="bg-gray-100 px-1 rounded">name:price</code>
                <br />
                <span className="text-sm italic">Example: Small:9.99;Large:12.99</span>
              </p>
            </div>
            <input type="file" accept="text/csv,text/plain" onChange={(e) => handleBulkUploadFile(e.target.files?.[0] || null)} disabled={bulkUploading} className="mb-4 w-full" />
            <div className="flex justify-end space-x-3 mt-6">
